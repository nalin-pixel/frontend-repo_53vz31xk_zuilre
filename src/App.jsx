...
export default function App({ locale = 'fa', theme = 'dark' }) {
      ...
      <section className="max-w-6xl mx-auto px-6 pb-20">
        ...
        <div className="grid md:grid-cols-4 gap-6">
          {[{
            ...
            title_fa: 'לایسנס CS2', title_en: 'CS2 License', price: '3,000,000/۸,000,000 تومان', to: '/product/cs2-license'
          },{
            title_fa: 'לایسנס Rainbow Six', title_en: 'R6 License', price: '3,000,000/۸,000,000 تومان', to: '/product/r6-license'
          }].map((c, i) => (
