  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-12">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        {items.map((p, i) => (
          <div key={i} onClick={()=>navigate(`/product/${p.slug}`)} className="cursor-pointer bg-[#141414] rounded-lg p-6 border border-white/10 hover:border-[#39FF14] transition-colors">
